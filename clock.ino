...
void timer2minsec(){
   ...
   Serial.print("CLOCK: ");Serial.print(min10);Serial.print(min01);Serial.print(":");Serial.print(sec10);Serial.print(sec01);Serial.println();
}


/**
 * draw clock - render the clock's digits
 */
void draw_clock(){
   ...
   //convert/update the clock's millisecond timer to min:sec
   timer2minsec();
